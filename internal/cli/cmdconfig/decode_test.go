...
func TestDecode_nilDest(t *testing.T) {
	if err := cmdconfig.Decode(map[string]any{}, nil); err == nil {
...
func TestDecode_nonPointerDest(t *testing.T) {
	...
	if err := cmdconfig.Decode(map[string]any{}, cfg{}); err == nil {
		t.Fatal("expected error, got nil")
	}
}
...
func TestDecode_nilPointerDest(t *testing.T) {
	...
	var p *cfg
	if err := cmdconfig.Decode(map[string]any{}, p); err == nil {
		t.Fatal("expected error, got nil")
	}
}
...
func TestDecode_pointerToNonStruct(t *testing.T) {
	n := 0
	if err := cmdconfig.Decode(map[string]any{}, &n); err == nil {
		t.Fatal("expected error, got nil")
	}
}
...
func TestDecode_success(t *testing.T) {
	c := decodeGoodConfig{Format: cmdconfig.Field[string]{Default: "standard"}, unexport: "private"}
...
func TestDecode_missingKey_leavesDefault(t *testing.T) {
	c := decodeGoodConfig{Format: cmdconfig.Field[string]{Default: "standard"}}
	if err := cmdconfig.Decode(map[string]any{}, &c); err != nil {
		t.Fatalf("Decode: %v", err)
	}
...
func TestDecode_internalField_isNotOverridden(t *testing.T) {
	...
	err := cmdconfig.Decode(map[string]any{"secret": "leaked"}, &c)
	if err == nil {
		t.Fatal("expected error, got nil")
	}
...
func TestDecode_unwrappedField_errors(t *testing.T) {
	err := cmdconfig.Decode(map[string]any{"bad": "x"}, &decodeUnwrappedFieldConfig{})
	if err == nil {
		t.Fatal("expected error, got nil")
	}
}
...
func TestDecode_setOverrideError_isPropagated(t *testing.T) {
	c := decodeSetOverrideErrorConfig{Count: cmdconfig.Field[int]{Default: 1}}
...
func TestDecode_unknownKey_rejected(t *testing.T) {
	c := decodeUnknownKeyConfig{Format: cmdconfig.Field[string]{Default: "standard"}}
	err := cmdconfig.Decode(map[string]any{"bogus_key": "spdx"}, &c)
	if err == nil {
		t.Fatal("expected error, got nil")
	}
	if got := c.Format.Value(); got != "standard" {
...
func TestDecode_unknownKey_nested(t *testing.T) {
	c := decodeGoodNestedConfig{
		Nested: cmdconfig.Field[decodeGoodNestedFixture]{
			Default: decodeGoodNestedFixture{A: cmdconfig.Field[bool]{Default: true}},
		},
	}
...
func TestDecode_collectsEveryFieldError(t *testing.T) {
	c := decodeMultipleBadFieldsConfig{
		Count: cmdconfig.Field[int]{Default: 1},
		Total: cmdconfig.Field[int]{Default: 1},
	}
